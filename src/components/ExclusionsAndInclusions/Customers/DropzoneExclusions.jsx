...
const DropzoneExclusions = () => {
	...
	// const exclusions = useSelector(state => state.exclusionsAndInclusions.SET_clientsExclusion);
	...
	const style = useMemo(
		...
		[acceptedFiles, isDragActive, isDragAccept, isDragReject, exclusions]
	);
	...
	return (
		...
		<div style={{ marginTop: '.3rem', width:'45rem' }}>
			<div
				{...getRootProps({ style })}
				className={acceptedFiles.length === 0 ? 'd-flex flex-column align-items-center pt-3' : 'pt-3'}>
				<input {...getInputProps()} />
